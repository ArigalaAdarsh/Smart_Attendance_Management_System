...
server = ''  #Add your Sql Server Details
database = ''
username = ''
password = ''
...
app = Flask(__name__)
app.secret_key = b'' # Add your flask app secret key 
import matplotlib
matplotlib.use('Agg')
...
cursor.execute(create_table_query)
create_table_query = '''IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'subjects')
BEGIN
   CREATE TABLE subjects(Id_number VARCHAR(50) , subjects VARCHAR(200));
END
'''
cursor.execute(create_table_query)

create_table_query = '''IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'images')
BEGIN 
   CREATE TABLE images(Id_number VARCHAR(50),image varchar(20));
END
'''
...
def create_faculty_table():
    ...
    cursor.execute(create_table_query)
    create_table_query ='''
        CREATE TABLE faculty_subjects (Id_number  VARCHAR(255) , subjects VARCHAR(255) );
    '''
    cursor.execute(create_table_query)
